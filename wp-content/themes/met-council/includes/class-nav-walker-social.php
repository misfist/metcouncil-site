<?php
/**
 * Nav Walker Class for Social Menu
 *
 * @package understrap
...
class WO_Nav_Social_Walker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
       ...
       if ( strpos( $item->url, 'facebook' ) !== false ) {
           $item_output .= '<a'. $attributes .'><i class="fa fa-facebook"></i>';
           $item_output .= '</a>';
           ...
           $item_output .= '<a'. $attributes .'><i class="fa fa-youtube">';
           $item_output .= '</i></a>';
           $item_output .= $args->after;
           ...
           $item_output .= '<a'. $attributes .'><i class="fa fa-vimeo">';
           $item_output .= '</i></a>';
           $item_output .= $args->after;
       }
