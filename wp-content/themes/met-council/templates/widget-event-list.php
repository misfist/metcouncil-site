	...
	<ul <?php echo $id; ?> class="<?php echo esc_attr( $classes );?>" > 
		...
		<?php while ( $eo_event_loop->have_posts() ) :  $eo_event_loop->the_post(); ?>
			...
			<li class="<?php echo esc_attr( implode( ' ', $eo_event_classes ) ); ?>" >
				<div class="event-date"><?php echo  eo_get_the_start( $format ); ?></div>
				<div class="event-title"><a href="<?php echo eo_get_permalink(); ?>"><?php the_title(); ?></a></div>
				<div class="event-location-name"><?php eo_venue_name(); ?></div>
			</li>
