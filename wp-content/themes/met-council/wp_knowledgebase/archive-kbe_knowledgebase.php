...
?>
	...
	if ( KBE_BREADCRUMBS_SETTING == 1 ) { ?>
		<div class="kbe_breadcrumbs"><?php kbe_breadcrumbs(); ?></div>
	<?php }
				...
				foreach ( $kbe_terms as $kbe_taxonomy ) {
					...
					<div class="kbe_category">
                        <h2>
							...
							<?php echo sprintf( _n( '%d Article', '%d Articles', $kbe_count_sum_parent, 'wp-knowledgebase' ), $kbe_count_sum_parent ); ?>
							</span>
						...
						<?php
							...
							<?php
								foreach ( $kbe_child_terms as $kbe_child_term ) {
									...
									<h3>
                                        <span class="kbe_count">
										<?php echo sprintf( _n( '%d Article', '%d Articles', $kbe_child_term->count, 'wp-knowledgebase' ), $kbe_child_term->count ); ?></span>
