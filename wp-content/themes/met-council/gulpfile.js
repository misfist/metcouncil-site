...
gulp.task( 'watch', function() {
    ...
    gulp.watch( [paths.dev + '/js/**/*.js', 'js/**/*.js', '!js/main.js', '!js/main.min.js'], ['scripts'] );
...
gulp.task( 'scripts', function() {
    var scripts = [
        ...
        // paths.dev + '/js/bootstrap-material-design/bootstrap-material-design.js',
        // paths.dev + '/js/material/material.js',
...
// Copy all JS files
    ...
    /* Copy Boostrap Material Design JS Files */
    // var stream = gulp.src( paths.node + 'daemonite-material/js/material.js' )
    //     .pipe( gulp.dest( paths.dev + '/js/material' ) );

    // var stream = gulp.src( paths.node + 'bootstrap-material-design/dist/js/**/*.js' )
    //     .pipe( gulp.dest( paths.dev + '/js/bootstrap-material-design' ) );

// Copy all Bootstrap SCSS files
    gulp.src( paths.node + 'bootstrap/scss/**/*.scss' )
        .pipe( gulp.dest( paths.dev + '/sass/bootstrap4' ) );

    /* Copy Boostrap Material Design SCSS Files */
    // gulp.src( paths.node + 'daemonite-material/assets/scss/**/*.scss' )
    //     .pipe( gulp.dest( paths.dev + '/sass/material' ) );

    // gulp.src( paths.node + 'bootstrap-material-design/scss/**/*.scss' )
    //     .pipe( gulp.dest( paths.dev + '/sass/bootstrap-material-design' ) );
